...
class PlayerFormatterTest extends JavascriptTestBase {
  ...
  public function testViewPlayerFormatter() {
    ...
    $this->click('#edit-submit');
    $this->assertSession()->responseContains('<iframe src="https://player.theplatform.com/p/public-id/DemoPlayer/select/media/Zy1n9JQPy6hw?autoPlay=false&playAll=false"></iframe>');
  }
